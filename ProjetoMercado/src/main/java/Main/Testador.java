...
public class Testador {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            mercado.addFuncionario("Matheus", 24, 1111, "Coordenador", new AvaliacaoOO2022 ("Matheus", "219041057", 10));
            mercado.addFuncionario("Folly", 23, 2222, "Gerente", new AvaliacaoOO2022 ("Matheus", "219041057", 10));
            mercado.addFuncionario("Pilotto", 25, 3333, "CEO", null);
            mercado.escreveArqFuncionarios();
            mercado.getFuncionarios();

            mercado.leArqFuncionarios();
            mercado.addFuncionario("Peixoto", 26, 4444, "CTO", new AvaliacaoOO2022 ("Matheus", "219041057", 10));
            mercado.escreveArqFuncionarios();
            mercado.getFuncionarios();
        }
