...
public class Mercado {
    ...
    public void escreveArqFuncionarios() throws FileNotFoundException, IOException, AvaliacaoOO2022NaoInformadaException{
        try{
            ...
            for(Funcionario func : this.funcionarios){ //para cada funcionario no array funcionarioS
                if(func.getAvaliacaoOO2022() == null){
                    throw new AvaliacaoOO2022NaoInformadaException("AvaliacaoOO2022 não informada!");
                }
    ...
    //Folly
    public void addFuncionario(String nome, int idade, int cadastro, String tipoFuncionario, AvaliacaoOO2022 avaliacaoOO2022) {
        Funcionario func = new Funcionario(nome, idade, cadastro, tipoFuncionario, avaliacaoOO2022); //cria funcionario pra add
